...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'ai.provider' => 'string',
            'ai.openai.key' => 'string',
            'ai.openai.model' => 'string',
            'ai.gemini.key' => 'string',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','concurrency.default',
'view.paths','view.compiled','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','hashing.driver','hashing.bcrypt.rounds',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','ai.provider',
'ai.openai.key','ai.openai.model','ai.gemini.key','ai.gemini.model','app.name',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','l5-swagger.default',
...
'logging.channels.stderr.handler','logging.channels.stderr.handler_with.stream','logging.channels.stderr.processors','logging.channels.syslog.driver','logging.channels.syslog.level',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','sanctum.stateful','sanctum.guard',
...
'ide-helper.soft_deletes_force_nullable','ide-helper.post_migrate',);
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie',);
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_TIMEZONE','LOG_CHANNEL',
'LOG_LEVEL','DB_CONNECTION','CACHE_DRIVER','SESSION_DRIVER','SESSION_LIFETIME',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','AI_PROVIDER',
'OPENAI_API_KEY','OPENAI_MODEL','GEMINI_API_KEY','GEMINI_MODEL','L5_SWAGGER_GENERATE_ALWAYS',
